...
-- Tiempo de generación: 16-12-2023 a las 17:05:43
...
CREATE TABLE IF NOT EXISTS `pacientes` (
  ...
  `Estatura (cm)` int UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `Rol` int NOT NULL,
  `Foto` varchar(35) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
